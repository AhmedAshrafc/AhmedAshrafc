...
- 🧰 I build with: `JavaScript`, `React.js`, `Vue.js`, `Next.js`, `Nuxt.js`, `Bootstrap`, `jQuery`, `Framer Motion`, `PrimeReact/PrimeVue`, `Tailwind CSS`, `Prisma`, `MongoDB`, `Firebase`, `PHP - Laravel`...
